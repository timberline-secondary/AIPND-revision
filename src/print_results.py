...
##
# TODO 7: EDIT and ADD code BELOW to do the following that's stated in the 
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # TODO: 7a. REPLACE print("") with CODE that prints the text string 
    ...
    for key in results_stats_dic:
        # TODO: 7b. REPLACE pass with CODE that prints out all the percentages 
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            # TODO: 7c. REPLACE pass with CODE that prints out the pet label 
