...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       # TODO: 4a. Set the string variable model_label to be the string that's 
       ...
       # TODO: 4b. BELOW REPLACE pass with CODE to process the model_label to 
       ...
       # TODO: 4c. REPLACE pass BELOW with CODE that uses the extend list function
       ...
       # TODO: 4d. REPLACE pass BELOW with CODE that uses the extend list function
       #           to add the classifier label (model_label) and the value of
