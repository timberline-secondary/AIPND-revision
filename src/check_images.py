...
def main():
    # TODO 1: Measures total program runtime by collecting start time
    start_time = time()
    
    # TODO 2: Define get_input_args function within the file get_input_args.py
    ...
    # TODO 4: Define classify_images function within the file classify_images.py
    ...
    # TODO 7: Define print_results function within the file print_results.py
    ...
    # TODO 1: Measure total program runtime by collecting end time
    end_time = time()
    
    # TODO 1: Computes overall runtime in seconds & prints it in hh:mm:ss format
